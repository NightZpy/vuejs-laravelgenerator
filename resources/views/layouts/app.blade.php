...
<body id="app" class="skin-blue sidebar-mini">
...
<script src="//cdnjs.cloudflare.com/ajax/libs/x-editable/1.5.0/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
    ...
    <script src="/vendor/vuestrap/vue-strap.min.js"></script>
    {{-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/vue-strap/1.0.11/vue-strap.min.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/vue-resource/0.1.16/vue-resource.min.js"></script>
    <script src="/vendor/vue-table/vue-table.js"></script> --}} 
    @stack('vue-scripts')
</body>
</html>